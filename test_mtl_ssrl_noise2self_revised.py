...
class Meta_test():
    ...
    def test(self):
        ...
        for itr in range(1):  
            ...
            for idx in (task_list):
                task_output = self.loss_fn.task_ft_ssrl_n2s(weights=self.model.state_dict(),task_idx = idx)
    ...
    def plot_result(self,task_output,idx):
        ...
        filename = "Test_Results/ours_ssrl_noise2self_task_"+str(idx)+"_updates_"+str(self.num_of_updates)
