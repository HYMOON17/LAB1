...
class Meta_test():
    ...
    def test(self):
        ...
        for itr in range(1):  
            ...
            for idx in (task_list):
                task_output = self.loss_fn.task_ft_n2s(weights=self.model.state_dict(),task_idx = idx)
    ...
    def plot_result(self,task_output,idx):
        ...
        filename = "Test_Results/noise2selfMTL_task_"+str(idx)+"_updates_"+str(self.num_of_updates)
